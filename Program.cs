////დავალება პირველი
////1.დაწერეთ თამაში სადაც იქნება სამი დონე 1 easy, 2 medium, 3 hard, 4 exit.
////2. თამაშის პრინციპია, თქვენი ლოგიკა აგენერირებს რაღაც Random რიცხვს და მოთამაშემ უნდა გამოიცნოს ეს რიცხვი განსაზღვრულ მცელობებში.
////3. easy მოუდში random რიცხვის შუალედი არის 1 დან 10  მცდელობების ოდენობა არის 10
////4. medium მოუდში random რიცხვის შუალედი არის 1 დან 20  მცდელობების ოდენობა არის 8
////5. hard მოუდში random რიცხვის შუალედი არის 1 დან 30  მცდელობების ოდენობა არის 5
////6. რიცხვის გამოცნობისას დაუწერეთ რომ წარმატებით გამოიცნო რიცხვი და თავიდან აარჩევინოს დონეები, თუ ვერ გამოიცნო იქამდე გაარძელოს რიცხვის შემოყვანა
////სანამ ცდების ოდენობა არ ამოეწურება, თუ ცდების ოდენობა ამოეწურა დაუწერეთ თქვენ წააგეთ და თავიდან აარჩევინოს დონე
...
Console.WriteLine("Romeli davalebis naxva Gindat: a b");
